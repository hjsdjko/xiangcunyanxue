...
public class YanxueLiuyanView extends YanxueLiuyanEntity implements Serializable {
	...
	public YanxueLiuyanView() {

	}

	public YanxueLiuyanView(YanxueLiuyanEntity yanxueLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, yanxueLiuyanEntity);
