...
public class YanxueCollectionView extends YanxueCollectionEntity implements Serializable {
	...
	*/
	...
	private String yanxueCollectionValue;
	...
	public YanxueCollectionView() {

	}

	public YanxueCollectionView(YanxueCollectionEntity yanxueCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, yanxueCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getYanxueCollectionValue() {
		return yanxueCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setYanxueCollectionValue(String yanxueCollectionValue) {
		this.yanxueCollectionValue = yanxueCollectionValue;
	}
	...
	public String toString() {
		return "YanxueCollectionView{" +
			", yanxueCollectionValue=" + yanxueCollectionValue +
