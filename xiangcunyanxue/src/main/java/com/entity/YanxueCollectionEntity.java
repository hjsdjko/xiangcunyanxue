...
public class YanxueCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public YanxueCollectionEntity() {

	}

	public YanxueCollectionEntity(T t) {
		try {
    ...
    public String toString() {
        return "YanxueCollection{" +
            ", id=" + id +
            ", yanxueId=" + yanxueId +
            ", yonghuId=" + yonghuId +
            ", yanxueCollectionTypes=" + yanxueCollectionTypes +
