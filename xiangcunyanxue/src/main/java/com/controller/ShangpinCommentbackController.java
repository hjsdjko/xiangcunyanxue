...
//        else if("用户".equals(role))
//            shangpinCommentback.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        if("".equals(shangpinCommentback.getShangpinCommentbackText()) || "null".equals(shangpinCommentback.getShangpinCommentbackText())){
                shangpinCommentback.setShangpinCommentbackText(null);
        }
        if("".equals(shangpinCommentback.getReplyText()) || "null".equals(shangpinCommentback.getReplyText())){
                shangpinCommentback.setReplyText(null);
        }
